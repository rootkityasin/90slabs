...
export default function TeamAndStack() {
  ...
  return (
    <section id="members" className="relative flex flex-col md:flex-row items-center justify-between bg-white overflow-hidden py-14 md:py-24">

      {/* LEFT SIDE: Typography + Team */}
      <div className="w-full md:w-1/2 p-6 sm:p-8 md:p-16 z-20 md:pl-16 lg:pl-24">
        <div className="max-w-xl">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-zinc-900 leading-[1.1] mb-5 md:mb-6">
            Crafted by experts, <br />
            <span className="text-zinc-300">driven by code.</span>
          </h2>

          <p className="text-base sm:text-lg text-zinc-600 mb-8 md:mb-12 leading-relaxed max-w-md">
          ...
          <div className="space-y-5 md:space-y-6 md:pl-6 lg:pl-10">
            ...
            <AvatarGroup className="-space-x-4 justify-start" translateX={0}>
      ...
      <div className="relative w-full md:w-1/2 h-[24rem] sm:h-[28rem] md:h-[45rem] flex items-center justify-center md:justify-start overflow-hidden">
        ...
        <div className="relative w-[28rem] h-[28rem] sm:w-[34rem] sm:h-[34rem] md:w-[50rem] md:h-[50rem] translate-x-0 sm:translate-x-[8%] md:translate-x-[30%] flex items-center justify-center">
          {/* Center Tech Logo */}
                ...
                {iconConfigs
                  ...
                  .map((cfg, iconIdx) => {
                    ...
                    return (
                      ...
                      >
                        <cfg.Icon className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" style={{ color: cfg.color }} />
                      </div>
                    );
                  })}
              </div>
